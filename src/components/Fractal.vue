...
export default {
  ...
  created() {    
    this.formData = this.prepareData(this.schema, this.formData)
  },
  ...
  methods: {   
    updateFormData(newFormData) {
      ...
      console.log('fractal triggered')
      this.formData = newFormData
    },

    prepareData(schema, formData) {
      let data = _cloneDeep(formData)   // use clone deep to prevent overwriting existing data
